...
class FavoriteAdapter(private var mFileList: ArrayList<DocNoteModel>, private val notesListener: FavoriteListeners) :
    RecyclerView.Adapter<FavoriteAdapter.NotesViewHolder>() {
    private var timer: Timer? = null
    var onItemLongClick: ((DocNoteModel) -> Unit)?= null
