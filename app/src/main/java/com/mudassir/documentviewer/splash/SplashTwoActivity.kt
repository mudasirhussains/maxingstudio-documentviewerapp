...
import com.mudassir.documentviewer.databinding.ActivitySplashTwoBinding
...
class SplashTwoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val adLoader = AdLoader.Builder(this@SplashTwoActivity, "ca-app-pub-3940256099942544/2247696110") //testing unit id
    ...
    private fun callBacks() {
        findViewById<Button>(R.id.btnLetsStart).setOnClickListener {
            startActivity(Intent(this@SplashTwoActivity, MainActivity::class.java))
            finish()
        }
    }
